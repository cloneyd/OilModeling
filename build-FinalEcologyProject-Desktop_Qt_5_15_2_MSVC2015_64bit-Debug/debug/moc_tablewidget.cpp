/****************************************************************************
** Meta object code from reading C++ file 'tablewidget.hpp'
**
...
#include <memory>
#include "../../FinalEcologyProject/HelperEntities/Table/tablewidget.hpp"
#include <QtCore/qbytearray.h>
#include <QtCore/qmetatype.h>
#if !defined(Q_MOC_OUTPUT_REVISION)
#error "The header file 'tablewidget.hpp' doesn't include <QObject>."
...
QT_MOC_LITERAL(3, 25, 12), // "TableWidget*"
QT_MOC_LITERAL(4, 38, 5) // "table"

    },
    "TableWidget\0closeSignal\0\0TableWidget*\0"
    "table"
};
...
void TableWidget::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        Q_UNUSED(_t)
        switch (_id) {
        case 0: _t->closeSignal((*reinterpret_cast< TableWidget*(*)>(_a[1]))); break;
        default: ;
        }
        ...
        {
            using _t = void (TableWidget::*)(TableWidget * );
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&TableWidget::closeSignal)) {
                *result = 0;
                return;
            }
        }
...
// SIGNAL 0
void TableWidget::closeSignal(TableWidget * _t1)
{
